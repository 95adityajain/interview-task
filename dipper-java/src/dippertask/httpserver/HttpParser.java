...
public class HttpParser {
  ...
  public String toString(){
      ...
      builder.append(params.toString()).append("\n");
  ...
  public int parseRequest() throws IOException {
    ...
    if (cmd[0].equals("GET") || cmd[0].equals("HEAD") || cmd[0].equals("PUT")) {
      method = cmd[0];
...
//  }
  private void parseHeaders(boolean parseBody) throws IOException {
    String line;
    int idx;
